...
void setup()
{
  ...
  Serial.print("Strlen: "); Serial.println(big_string.length());
  Serial.print("RAM: "); Serial.println(sizeof(big_string));
  ...
  for (int i=0; big_string[i]; ++i) // inspect each character in the string
    if (big_string[i] == ',')
      ++comma_count;
  Serial.print(comma_count); Serial.println(" commas.");
  ...
  Serial.print("Extracted: \""); Serial.print(extract); Serial.println("\"");

  // 2.e Print the string
  big_string.print(Serial); Serial.println();
  ...
  font_table.print(Serial); Serial.println();

  // 4.b Determine the size of the array
  Serial.print("Rows: "); Serial.println(font_table.rows());
  Serial.print("Cols: "); Serial.println(font_table.cols());
  Serial.print("RAM: "); Serial.println(sizeof(font_table));

  // 4.c Access individual elements of the array using [] notation
  Serial.print("q: "); font_table['q'].print(Serial); Serial.println();

  // Example 5: Arrays of strings
  // String arrays require PSTR notation
  // and must be declared inside the body of a function
  ...
  Serial.println("\nPIPS");
  pips.print(Serial); Serial.println();
  for (int i=0; i<pips.count(); ++i)
  {
    ...
    pips[i].print(Serial);
    Serial.print("(len=");
    Serial.print(pips[i].length());
    Serial.println(")");
  }

  Serial.println("\nSUITS");
  suits.print(Serial); Serial.println();
  for (int i=0; i<suits.count(); ++i)
  {
    Serial.print(i);
    Serial.print(" ");
    suits[i].print(Serial);
    Serial.print("(len=");
    Serial.print(suits[i].length());
    Serial.println(")");
  }
  ...
  for (int i=0; i<10; ++i)
  {
    ...
    int suit = random(4);
    Serial.print("The ");
    pips[pip].print(Serial);
    Serial.print(" of ");
    suits[suit].print(Serial);
    Serial.println();
  }
}
